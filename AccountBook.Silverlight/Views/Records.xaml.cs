    ...
    public partial class Records : Page
    {
        ...
        protected override void OnNavigatedTo(NavigationEventArgs e)
        {
            ...
            if (!AccountBookContext.Instance.ModuleCache.ContainsKey(this.GetType()))
            {
                ...
                Uri xapUri = new Uri(HtmlPage.Document.DocumentUri, "ClientBin/AccountBook.Records.xap");
        ...
        private void ManageXapOpenReadCompleted(object sender, OpenReadCompletedEventArgs e)
        {
            if (e.Error == null)
            {
                ...
                var manageModule = assembly.CreateInstance("AccountBook.Records.MainPage") as UserControl;
