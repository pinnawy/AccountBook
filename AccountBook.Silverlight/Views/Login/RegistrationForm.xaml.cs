    ...
    public partial class RegistrationForm : StackPanel
    {
        ...
        private void RegisterForm_AutoGeneratingField(object dataForm, DataFormAutoGeneratingFieldEventArgs e)
        {
            ...
            if (e.PropertyName == "UserName")
            {
                ...
                this._userNameTextBox.LostFocus += this.UserNameLostFocus;
            }
        ...
        private void RegisterButton_Click(object sender, RoutedEventArgs e)
        {
            ...
            {
                this.registrationData.CurrentOperation = this._userContext.CreateUser(
                    this.registrationData,
                    this.registrationData.Password,
                    this.RegistrationOperation_Completed, null);

                this._parentWindow.AddPendingOperation(this.registrationData.CurrentOperation);
            }
        }
        ...
        {
            this._parentWindow.NavigateToLogin();
        }
